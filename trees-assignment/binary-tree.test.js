...
beforeEach(function() {
  ...
  let node5 = new BinaryTreeNode(5, null, node6);
  let node4 = new BinaryTreeNode(4);
  let node2 = new BinaryTreeNode(2,node3, node4);
  let node3 = new BinaryTreeNode(3,null,null);
  let node1 = new BinaryTreeNode(1, node2,node5)
  ...
  //extra test tree
  let node13 = new BinaryTreeNode(1);
  let node12 = new BinaryTreeNode(1);
  let node11 = new BinaryTreeNode(1);
  let node10 = new BinaryTreeNode(2,node13);
  let node9 = new BinaryTreeNode(3, node10, node12);
  let node8 = new BinaryTreeNode(5, node9, node11);
  let node7 = new BinaryTreeNode(5);
  let root2 = new BinaryTreeNode(6, node7, node8);
  let xLargeTree = new BinaryTree(root2);
